...
contract TournamentDeckCatalogCardsTest is Test {
    ...
    function test_RegisterInstantCard() public {
        TournamentDeckCatalog.CardDefinition memory card = TournamentDeckCatalog
            .CardDefinition({
                ...
                resourceType: TournamentDeckCatalog.ResourceCard.None,
                baseWeight: 100,
    ...
    function test_RegisterResourceCard() public {
        TournamentDeckCatalog.CardDefinition memory card = TournamentDeckCatalog
            .CardDefinition({
                exists: true,
                paused: false,
                ...
                trigger: TournamentDeckCatalog.ModifierTrigger.None,
                resourceType: TournamentDeckCatalog.ResourceCard.Rock,
                baseWeight: 50,
                effectData: mockNoEffectData()
            });
    ...
    function test_RegisterModifierCard_RevertWhen_HasResource() public {
        TournamentDeckCatalog.CardDefinition memory card = TournamentDeckCatalog
            .CardDefinition({
                ...
                resourceType: TournamentDeckCatalog.ResourceCard.Paper,
                baseWeight: 100,
                effectData: mockNoEffectData()
            });
    ...
    function test_RegisterResourceCard_RevertWhen_NoResource() public {
        TournamentDeckCatalog.CardDefinition memory card = TournamentDeckCatalog
            .CardDefinition({
                exists: true,
                paused: false,
    ...
    function test_RegisterResourceCard_RevertWhen_HasTrigger() public {
        TournamentDeckCatalog.CardDefinition memory card = TournamentDeckCatalog
            .CardDefinition({
                exists: true,
                paused: false,
                ...
                resourceType: TournamentDeckCatalog.ResourceCard.Scissors,
                baseWeight: 100,
                effectData: mockNoEffectData()
            });
    ...
    function testFuzz_RegisterValidResourceCard(
        uint8 cardId,
        uint8 resourceIndex,
        uint16 baseWeight
    ) public {
        ...
        vm.assume(baseWeight > 0);
        TournamentDeckCatalog.ResourceCard resourceType = TournamentDeckCatalog
            .ResourceCard(resourceIndex);
        ...
        require(
            retrieved.resourceType == resourceType,
